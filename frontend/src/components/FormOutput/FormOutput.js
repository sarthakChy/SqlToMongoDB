...
const FormOutput = (props) => {
  ...
  return (
    <>
      ...
      <h3 style={{ textAlign: "center" }}>SQL → MongoDB</h3>
      <p style={{ textAlign: "center" }}>Generated MongoDB pipeline / query JSON.</p>
      <hr />
      <Form.Row>
        <Form.Group as={Col} controlId="formSqlToMongo">
          <div className={styles.mongoWrapper}>
            {renderSqlToMongo()}
          </div>
        </Form.Group>
      </Form.Row>
